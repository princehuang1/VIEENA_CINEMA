    ...
    <div className="bg-neutral-800 p-6 rounded-xl text-white">
      ...
      <div className="flex justify-center gap-4 md:gap-6">
        ...
        <div className="flex flex-col space-y-2 justify-center">
          {rowLabels.map(label => (
            <div 
              key={`left-${label}`} 
              className="w-8 h-8 md:w-8 md:h-8 flex items-center justify-center text-white font-bold text-lg"
            >
              {label}
            </div>
          ))}
      ...
      <div className="flex justify-center space-x-6 mt-8">
        <div className="flex items-center">
          <div className="w-5 h-5 rounded-md bg-neutral-600 mr-2"></div>
          <span className="text-sm text-gray-400">可選擇</span>
        </div>
        <div className="flex items-center">
          <div className="w-5 h-5 rounded-md bg-purple-600 mr-2"></div>
          <span className="text-sm text-gray-400">已選擇</span>
        </div>
        <div className="flex items-center">
          <div className="w-5 h-5 rounded-md bg-red-600 mr-2"></div>
          <span className="text-sm text-gray-400">已售出</span>
        </div>
      </div>
    </div>
  );
